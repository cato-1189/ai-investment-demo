...
def build_pilot_report(out_root: Path, command: list[str], stdout: str, stderr: str) -> dict[str, Any]:
    ...
    report = {
        ...
        "coverage_by_data_type": dq.get("coverage_by_data_type", {}),
